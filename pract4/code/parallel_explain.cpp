...
int main(int argc, char **argv) {
  ...
  */
  ...
  /*
    ...
    …, (p1 - 1; 0) ) при помощи MPI_Bcast раздает свою полосу матрицы
    A всем процессам своей горизонтали. Т.е. процесс (1;0) раздает
    свою полосу процессам (1;1), (1;2), ...
  */
  ...
  */
  ...
  /*MPI_type_commit
    ...
    типов или посылки/приёма данных) *если новый тип хотим
